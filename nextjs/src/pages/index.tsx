                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="bg-card border border-border rounded-lg p-4 space-y-2">
                        <div className="text-xs text-muted-foreground font-medium">Videos Analyzed</div>
                        <div className="text-2xl font-bold">1,247</div>
                        <div className="text-xs text-green-600">+12% this week</div>
                      </div>
                      <div className="bg-card border border-border rounded-lg p-4 space-y-2">
                        <div className="text-xs text-muted-foreground font-medium">Avg Hook Score</div>
                        <div className="text-2xl font-bold">87</div>
                        <div className="text-xs text-muted-foreground">out of 100</div>
                      </div>
                      <div className="bg-card border border-border rounded-lg p-4 space-y-2">
                        <div className="text-xs text-muted-foreground font-medium">Top Hook Type</div>
                        <div className="text-lg font-bold">Bold Statement</div>
                        <div className="text-xs text-muted-foreground">32% of videos</div>
                      </div>
                      <div className="bg-card border border-border rounded-lg p-4 space-y-2">
                        <div className="text-xs text-muted-foreground font-medium">Engagement Rate</div>
                        <div className="text-2xl font-bold">8.4%</div>
                        <div className="text-xs text-green-600">+2.1% avg</div>
                      </div>
                    </div>

                    {/* Hook Analysis Preview */}
                    <div className="bg-card border border-border rounded-lg p-6 space-y-4">
                      <div className="flex items-center justify-between">
                        <h3 className="text-sm font-semibold">Recent Hook Analysis</h3>
                        <span className="text-xs text-muted-foreground">Last 24 hours</span>
                      </div>
                      <div className="space-y-3">
                        <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                          <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg" />
                          <div className="flex-1 min-w-0 space-y-1">
                            <div className="text-sm font-medium truncate">&quot;The secret nobody tells you about...&quot;</div>
                            <div className="text-xs text-muted-foreground">Curiosity Gap • 2.3M views • 9.2% engagement</div>
                            <div className="flex gap-2">
                              <span className="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-0.5 rounded">Score: 94</span>
                              <span className="text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded">Trending</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                          <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg" />
                          <div className="flex-1 min-w-0 space-y-1">
                            <div className="text-sm font-medium truncate">&quot;Watch this before it&apos;s too late...&quot;</div>
                            <div className="text-xs text-muted-foreground">Urgency • 1.8M views • 7.8% engagement</div>
                            <div className="flex gap-2">
                              <span className="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-0.5 rounded">Score: 89</span>
                              <span className="text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-2 py-0.5 rounded">High Impact</span>
                            </div>
                          </div>
                        </div>
                      </div>
